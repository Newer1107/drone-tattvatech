...
export function ChapterClassroom({
  ...
  return (
    <section ref={cbRef} className="relative bg-white" style={{ minHeight: "100vh" }}>
...
export function ChapterWorkshop({
  ...
  return (
    <section ref={cbRef} className="relative bg-[#fafaf8]" style={{ minHeight: "100vh" }}>
...
export function ChapterLab({
  ...
  return (
    <section ref={cbRef} className="relative bg-[#0d0d0d] text-white" style={{ minHeight: "100vh" }}>
      {/* Drone left half */}
